...
$(document).ready(function () {
    ...
    $(".mob-toggler").on("click", function () {
        $(
            ".pcoded-header > .collapse,.pcoded-header > .container > .collapse"
        ).toggleClass("d-flex");
    });
    ...
    $(".card-option .reload-card").on("click", function () {
        ...
        $this
            .parents(".card")
            .append(
                '<div class="card-loader"><i class="pct-loader1 anim-rotate"></div>'
            );
        setTimeout(function () {
                    ...
                    if (
                        ...
                        if (
                            ...
                            $(
                                ...
                                e.stopPropagation();
                                var str =
                                    $(this).closest(".pcoded-submenu").length;
                                if (str === 0) {
                ...
                if ($(".pcoded-navbar").hasClass("theme-horizontal") == true) {
                    if (
                        ...
                        if (
                            ...
                            var $dropdown = $(
                                ".theme-horizontal .pcoded-inner-navbar > li"
                            );
                            $dropdown
                                .off("click")
                                .off("mouseenter mouseleave")
    ...
    if (!$("body").hasClass("layout-14")) {
        if (this.href == pageUrl && $(this).attr("href") != "") {
            ...
            $(this)
                ...
                .addClass("active");
            if (
                $("body").hasClass("layout-1") ||
                $("body").hasClass("layout-9")
            ) {
